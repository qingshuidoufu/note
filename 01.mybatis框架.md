...
##### 三层架构:
 ...
 3. 持久层(数据库交互)
    ...
    ![01三层架构](01.mybatis框架.assets/01三层架构.png)
...
​			![image-20210510102258711](01.mybatis框架.assets/image-20210510102258711.png)

![mybatis底层分析](01.mybatis框架.assets/mybatis底层分析.png)
...
5. mybatis中的配置: (主配置文件:SqlMapConfig.xml)
   ...
   ![](01.mybatis框架.assets/image-20210511131847870.png)
   ...
   ![自定义mybatis开发流程图](01.mybatis框架.assets/自定义mybatis开发流程图.png)
   
   
   
   源码分析如下(目前不是我水平....看不懂):
   
   ![image-20210511225251794](01.mybatis框架.assets/image-20210511225251794.png)
...
1. 连接池:
   ...
   1. 我们在实际开发中我们都会使用连接池, 因为能减少获取连接的时间, 类似一个容器, 先获取连接放在容器中,当需要使用的时候就使用容器中的连接
      ...
      ![无标题](01.mybatis框架.assets/无标题.png)
...
![image-20210512090259398](01.mybatis框架.assets/image-20210512090259398.png)
...
![image-20210512090547387](01.mybatis框架.assets/image-20210512090547387.png)

![image-20210512091322873](01.mybatis框架.assets/image-20210512091322873.png)
...
​		![无标题1](01.mybatis框架.assets/无标题1.png)
...
![image-20210512152813812](01.mybatis框架.assets/image-20210512152813812.png)
...
![image-20210512170548851](01.mybatis框架.assets/image-20210512170548851.png)
...
![image-20210512195657278](01.mybatis框架.assets/image-20210512195657278.png)
...
![image-20210513034546106](01.mybatis框架.assets/image-20210513034546106.png)
