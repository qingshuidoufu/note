...
1. 平衡符号（符号匹配）
   ...
   ![image-20221124094530653](images/1.数据结构与算法笔记/image-20221124094530653.png)

2. 后缀表达式（逆波兰记法）

   即把操作的符号放在两个操作数的后面例如

   ![image-20221124095246402](images/1.数据结构与算法笔记/image-20221124095246402.png)

   其计算过程正可以使用一个栈来计算： 

   - **栈将遇到的数字入栈，遇到符号则出栈顶的两个数字计算后重新入栈**
